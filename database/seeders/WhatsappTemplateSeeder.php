    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                'variables' => ['name', 'username', 'sponsor_name', 'upline_name', 'join_date', 'login_url'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
            ...
            [
                ...
                'variables' => ['name', 'month', 'new_downlines', 'total_commission', 'total_withdrawal', 'balance'],
                'is_active' => true,
                'created_by' => null,
            ],
            ...
            [
                ...
                'variables' => ['name', 'amount', 'commission_type', 'from_member', 'date', 'balance'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
                ...
                'variables' => ['name', 'new_level', 'commission_percentage'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
                ...
                'variables' => ['name', 'bonus_amount', 'target_description', 'period'],
                'is_active' => true,
                'created_by' => null,
            ],
            ...
            [
                ...
                'variables' => ['name', 'amount', 'bank_name', 'account_number', 'account_name', 'date'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
                ...
                'variables' => ['name', 'amount', 'bank_name', 'account_number', 'account_name', 'date', 'admin_name'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
                ...
                'variables' => ['name', 'amount', 'date', 'reason'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
                ...
                'variables' => ['name', 'amount', 'bank_name', 'account_number'],
                'is_active' => true,
                'created_by' => null,
            ],
            ...
            [
                ...
                'variables' => ['member_name', 'member_phone', 'member_username', 'sponsor_name', 'date'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
                ...
                'variables' => ['member_name', 'amount', 'bank_name', 'account_number', 'date'],
                'is_active' => true,
                'created_by' => null,
            ],
            [
                ...
                'variables' => ['date', 'new_members', 'total_commission', 'pending_withdrawals', 'approved_amount'],
                'is_active' => true,
                'created_by' => null,
            ],
