        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('admin.whatsapp.templates.index') }}"
                    class="flex items-center rounded-lg px-3 py-2.5 text-gray-900 hover:bg-gray-100 {{ request()->routeIs('admin.whatsapp.templates.*') ? 'bg-gray-100' : '' }}">
                    <svg class="h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="{{ route('admin.whatsapp.logs.index') }}"
                    class="flex items-center rounded-lg px-3 py-2.5 text-gray-900 hover:bg-gray-100 {{ request()->routeIs('admin.whatsapp.logs.*') ? 'bg-gray-100' : '' }}">
                    <svg class="h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="{{ route('admin.whatsapp.settings.index') }}"
                    class="flex items-center rounded-lg px-3 py-2.5 text-gray-900 hover:bg-gray-100 {{ request()->routeIs('admin.whatsapp.settings.*') ? 'bg-gray-100' : '' }}">
                    <svg class="h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
