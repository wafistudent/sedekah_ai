    ...
    <div class="flex h-full flex-col overflow-y-auto px-3 py-4">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li class="pt-4 mt-4 border-t border-gray-200">
                <p class="mb-2 px-3 text-xs font-semibold uppercase text-gray-500">WhatsApp</p>
            </li>

            <li>
                <a href="{{ route('admin.whatsapp.templates.index') }}"
                    class="flex items-center rounded-lg px-3 py-2.5 text-gray-900 hover:bg-gray-100 {{ Str::startsWith(request()->route()->getName(), 'admin.whatsapp.templates') ? 'bg-gray-100' : '' }}">
                    <svg class="h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="{{ route('admin.whatsapp.logs.index') }}"
                    class="flex items-center rounded-lg px-3 py-2.5 text-gray-900 hover:bg-gray-100 {{ Str::startsWith(request()->route()->getName(), 'admin.whatsapp.logs') ? 'bg-gray-100' : '' }}">
                    <svg class="h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="{{ route('admin.whatsapp.settings.index') }}"
                    class="flex items-center rounded-lg px-3 py-2.5 text-gray-900 hover:bg-gray-100 {{ Str::startsWith(request()->route()->getName(), 'admin.whatsapp.settings') ? 'bg-gray-100' : '' }}">
                    <svg class="h-5 w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
