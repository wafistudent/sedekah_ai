...
<header class="fixed top-0 left-64 right-0 z-30 border-b border-gray-200 bg-white">
    <div class="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        {{-- Mobile menu button --}}
        <button type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 lg:hidden">
        ...
        <div class="flex items-center space-x-4 ml-auto">
            {{-- PIN Balance --}}
            <div class="flex items-center space-x-2 rounded-lg bg-blue-50 px-3 py-2">
                <svg class="h-5 w-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"/>
                    <path fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd"/>
                </svg>
                <span class="text-sm font-medium text-blue-900">PIN: {{ auth()->user()->pin_point }}</span>
            </div>
