...
<div class="mx-auto max-w-2xl space-y-6">
    {{-- Page Header --}}
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Purchase PIN for Member</h1>
    ...
    <form method="POST" action="{{ route('admin.pins.purchase.store') }}" class="space-y-6 bg-white rounded-lg shadow p-6">
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('admin.members') }}" class="rounded-md bg-white px-4 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                Cancel
            </a>
            <button 
                type="submit" 
