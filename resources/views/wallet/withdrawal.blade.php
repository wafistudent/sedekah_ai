...
<div class="mx-auto max-w-2xl space-y-6">
    {{-- Page Header --}}
    <div>
        <h1 class="text-xl font-bold text-gray-900 lg:text-2xl">Request Withdrawal</h1>
    ...
    <form method="POST" action="{{ route('wallet.withdrawal.store') }}" class="space-y-6 bg-white rounded-lg shadow p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-end gap-3">
            <a href="{{ route('wallet.index') }}" class="inline-flex items-center justify-center rounded-md bg-white px-6 py-3 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                Cancel
            </a>
            <button 
                type="submit" 
